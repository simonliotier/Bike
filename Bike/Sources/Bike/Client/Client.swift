...
/// Client used to fetch user-related data.
///
/// The underlying implementation relies on the `ClientProtocol` that we wrap in a class because a concrete type is
/// needed to use with `@Environment`.
@Observable
